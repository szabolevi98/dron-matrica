...
| Mini matrica | 26 × 10 mm | Akkura, kontrollerre, táskára |
...
- **Titkos kód védelem** — a regisztrációs szám kötőjeles hármas végződését (ami csak a Remote ID-be való) automatikusan levágja
